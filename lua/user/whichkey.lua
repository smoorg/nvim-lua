...
local mappings = {
    ...
    g = {
        ...
        L = { "<cmd>Gitsigns blame<cr>", "Blame file" },
    ...
    d = {
        name = "DAP",
        c = { "<cmd>lua require('dap-go').continue()<cr>", "Continue" },
        s = { "<cmd>lua require('dap-go').debug_test()<cr>", "Debug Test @" },
        l = { "<cmd>lua require('dap-go').debug_last_test()<cr>", "Debug Last Test @" },
        L = { "<cmd>lua require('dap-go').run_last()<cr>", "Run Last" },
        r = { "<cmd>lua require('dap-go').restart()<cr>", "Restart" },
        t = { "<cmd>lua require('dap-go').Terminate()<cr>", "Terminate" },
	...
	c = { function () require('telescope.builtin').colorscheme() end, "Colorscheme" },
